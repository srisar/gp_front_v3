<template>
	<AdminLayout>
		...
		<!-- region :Menubar: -->
		<MenuBarContainer>
			<MenuBarItem label="User type" class="w-64">
				<ListBox :list-items="menuUserTypes" v-model="queryFetchUsers.role" :has-footer="false" :has-label="false" />
			</MenuBarItem>
			<MenuBarItem>
...
import UsersList from "@/page_components/users/UsersList.vue";
