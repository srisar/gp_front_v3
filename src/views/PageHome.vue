		...
		<div>
			...
			<div class="flex gap-5 mb-5">
				...
				<div v-if="fetchUsers.canAbort">
					<button class="btn btn-primary" @click="fetchUsers.abort()">Cancel request</button>
				</div>
			</div>
...
import {useFetchUserApi, useFetchUsersApi} from '@/_backend/api/users/UsersApi';


const fetchUsers = reactive(useFetchUsersApi());

const fetchUser = reactive(useFetchUserApi(1));
